---
name: ired-wechat-echart
description: A comprehensive guide and code snippets for integrating the official ECharts component into a WeChat Mini Program. It demonstrates how to visualize health data (such as multi-line temperature charts) from iREd BLE (Bluetooth Low Energy) devices using WXML (WeiXin Markup Language), JS (JavaScript), JSON (JavaScript Object Notation), and CSS (Cascading Style Sheets).
---
